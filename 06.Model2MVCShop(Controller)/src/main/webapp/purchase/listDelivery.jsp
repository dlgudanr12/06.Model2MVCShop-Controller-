...
<body bgcolor="#ffffff" text="#000000">
	...
	<div style="width: 98%; margin-left: 10px;">
		...
		<form name="detailForm" action="/listDelivery.do"
			method="post">
					...
					<td align="right">
						<select
							name="searchOrderBy" class="ct_input_g" style="width: 100px">
								<option value="0" ${search.searchOrderBy=='0' ? "selected" : "" }>배송번호 순</option>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"
				...
				<c:forEach var="purchase" items="${list}">
					...
					<tr class="ct_list_pop">
						...
						<td></td>
						<td align="left"><a
							href="/getPurchase.do?tranNo=${purchase.tranNo }&menu=${menu}">
						...
						<td align="left">
								<c:if test="${purchase.tranCode!=null}">
									<c:if test="${purchase.tranCode=='1' }">구매완료
										<a
											href="/updateTranCode.do?tranNo=${purchase.tranNo }&tranCode=${purchase.tranCode }
											&currentPage=${search.currentPage}
											&searchCondition=${search.searchCondition}
											&searchKeyword=${search.searchKeyword}">배송하기</a>
									</c:if>
